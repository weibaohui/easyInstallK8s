...
docker pull weibh/kube-apiserver:v1.13.1
docker pull weibh/kube-controller-manager:v1.13.1
docker pull weibh/kube-scheduler:v1.13.1
docker pull weibh/kube-proxy:v1.13.1
...
docker pull weibh/addon-resizer:1.8.1

docker tag weibh/etcd:3.2.24 k8s.gcr.io/etcd:3.2.24
docker tag weibh/kube-apiserver:v1.13.1 k8s.gcr.io/kube-apiserver:v1.13.1
docker tag weibh/kube-controller-manager:v1.13.1 k8s.gcr.io/kube-controller-manager:v1.13.1
docker tag weibh/kube-scheduler:v1.13.1 k8s.gcr.io/kube-scheduler:v1.13.1
docker tag weibh/kube-proxy:v1.13.1 k8s.gcr.io/kube-proxy:v1.13.1
...
docker tag weibh/addon-resizer:1.8.1 k8s.gcr.io/addon-resizer:1.8.1
