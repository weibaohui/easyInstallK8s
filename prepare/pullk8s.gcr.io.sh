...
docker tag k8s.gcr.io/kube-controller-manager:v1.12.2 weibh/kube-controller-manager:v1.12.2
docker tag k8s.gcr.io/kube-scheduler:v1.12.2 weibh/kube-scheduler:v1.12.2
docker tag k8s.gcr.io/kube-proxy:v1.12.2 weibh/kube-proxy:v1.12.2
...
docker tag k8s.gcr.io/metrics-server-amd64:v0.2.1 weibh/metrics-server-amd64:v0.2.1
docker tag k8s.gcr.io/addon-resizer:1.8.1 weibh/addon-resizer:1.8.1
docker tag quay.io/coreos/flannel:v0.10.0-amd64 weibh/flannel:v0.10.0-amd64

docker push weibh/etcd:3.2.24
docker push weibh/kube-apiserver:v1.12.2
docker push weibh/kube-controller-manager:v1.12.2
docker push weibh/kube-scheduler:v1.12.2
docker push weibh/kube-proxy:v1.12.2
docker push weibh/coredns:1.2.2
docker push weibh/pause:3.1
docker push weibh/flannel:v0.10.0-amd64
docker push weibh/kubernetes-dashboard-amd64:v1.10.0
docker push weibh/addon-resizer:1.8.1
docker push weibh/metrics-server-amd64:v0.2.1